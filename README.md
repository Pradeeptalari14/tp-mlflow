# 📈 MLflow Tracking Studio
> Deploy centralized model training registries. Generate database-backed experiment trackers, Docker Compose service meshes, Kubernetes manifests, and Python metrics logs.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/mlflow/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/mlflow/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-mlflow.git
cd tp-mlflow
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/mlflow/) |
